...
def run_monte_carlo_simulations(players_dict, num_trials=1000):
    """
    Runs Monte Carlo simulations for all players to evaluate 
    floor risk, median expectation, and ceiling upside.
    """
    simulated_results = {}
    ...
    for pid, p in players_dict.items():
        try:
            ...
            xgi_90 = float(p.get("xgi_90", 0.25))
