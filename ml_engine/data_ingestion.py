...
def fetch_fbref_data(leagues=("Big 5 European Leagues Combined", "EFL Championship"), seasons="2526") -> pd.DataFrame:
    ...
    for league in leagues:
        try:
            ...
            clean_df['source_league'] = "EFL Championship" if "EFL Championship" in league else "Premier_League"
